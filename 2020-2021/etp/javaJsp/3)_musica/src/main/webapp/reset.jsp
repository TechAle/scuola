...
<div id="content">
    ...
    <!-- Il nostro content -->
    <div id="mainContent">
        <!-- Form per inserire vecchia e nuova password -->
        <div style="text-align: center" id="form">
            <h1 id="titolo">Reset</h1>
            <form method="post" action="cambioPass">
                <div class="form-group">
                    <label for="passwordVecchia">Password Vecchia</label>
                    <input type="password" class="form-control" id="passwordVecchia" name="passwordVecchia" aria-describedby="password">
                </div>
                <div class="form-group">
                    <label for="passwordNuova">Password Nuova</label>
                    <input type="password" class="form-control" id="passwordNuova" name="passwordNuova" aria-describedby="password">
                </div>
                <button type="submit" class="btn btn-primary" name="resetPass">Reset</button>
                <button type="submit" class="btn btn-primary" name="resetNoPass">Reset senza password</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                usate il bottone "reset senza password" per potere cambiare la password senza sapere la password corrente
            </div>
