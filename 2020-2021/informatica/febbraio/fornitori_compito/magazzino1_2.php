...
Elenco dei prodotti con nome, sconto, costo acquisto e ragione sociale ordinato per ragione e prodotto    </div>
    ...
    sconto,
    tbacquisti.costo as "costo acquisto",
    ragionesociale as "ragione sociale"
    
    from tbarticoli, tbacquisti, tbfornitori
    where tbarticoli.idarticolo = tbacquisti.ksarticolo = tbarticoli.ksreparto and tbacquisti.ksfornitore = tbfornitori.idfornitori
    order by  ragionesociale, articolo
    SQL;
