...
Elenco dei prodotti con nome, sconto, costo acquisto e ragione sociale ordinato per ragione e prodotto    </div>
    ...
    select 
    reparto,
    sum(giacenza * costo) as "valore reparto"
    from tbarticoli, tbreparti, tbacquisti
    where  tbarticoli.ksreparto = tbreparti.idreparto  and tbarticoli.idarticolo = tbacquisti.ksarticolo
    group by reparto    
SQL;
