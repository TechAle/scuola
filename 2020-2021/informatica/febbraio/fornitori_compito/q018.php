...
Visualizzare il numero di livelli diversi a cui appargono i dipendenti di una determinata provincia(scelta con menù a tendina)
</div>
<br>
<?php
...
if (isset($_POST['submit'])) 
    ...
    $query=<<<SQL
        SELECT COUNT(DISTINCT Livello) as "Numero livelli"
        FROM personale 
