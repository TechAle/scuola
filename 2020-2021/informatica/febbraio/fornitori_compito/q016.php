...
<html lang="it">
<head>
<title>Visualizzazione tabella con campi dinamici</title>
  <meta charset="UTF-8"/>
...
Visualizzare il numero di province diverse presenti nella tabella personale
</div>
<br>
...
$query=<<<SQL
    SELECT COUNT(DISTINCT Prov) as "Numerosità province"
    FROM personale;
    SQL;
