...
elenco articoli con descriziome, prezzo, reparto, categoria    </div>
    <br>
    <?php
    ...
    reparto,
    categoria
    from tbarticoli, tbreparti, tbcategorie
    where ksreparto = idreparto and kscategoria = idcategoria
    SQL;
