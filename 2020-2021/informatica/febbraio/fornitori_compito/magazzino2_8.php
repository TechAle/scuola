...
<main role="main" class="container">
    ...
    Prendere l'articolo con il prezzo minore nella categoria mouse
         </div>    <br>
    <?php
    ...
    where kscategoria = idcategoria and categoria = "mouse" and prezzovendita = (
    select min(prezzovendita) from tbarticoli, tbcategorie where kscategoria = idcategoria and categoria = "mouse"
    )
