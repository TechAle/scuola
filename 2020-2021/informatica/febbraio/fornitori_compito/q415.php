...
[ALL] Elenco con cognome, nome, funzione dei dipendenti che non sono impiegati e che hanno lo stipendio inferiore a quello di tutti gli impiegati
</div>
<br>
<?php 
...
$query=<<<SQL
    ...
    FROM personale
    WHERE Funzione <> "Impiegato" AND StipBase < ALL
                                                    (
                                                    SELECT StipBase
                                                    FROM personale
