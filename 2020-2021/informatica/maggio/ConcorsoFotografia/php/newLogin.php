...
if (!empty($_POST["login"])) {
    ...
    $user = $auth->getMemberByUsername($email);
    if ($user == null || $user == "") {
        $messaggio = "Login non valido";
    } else if($user[0]['is_locked'] == true){
        $messaggio = "Membro bloccato: Controllare la casella postale in caso di espulsione definitiva/Aspettare 24h";
                        ...
                        <form action="" method="post" id="frmLogin">
                            ...
                            <div class="row">
                                ...
                                <input name="member_password" type="password"
                                       ...
                                       class="input-field form__input" placeholder="Password">
                            </div>
                            <center>
                                <div class="remember">
                                    <input type="checkbox" name="remember_me" id="remember remember_meLogin"
                                        <?php if(isset($_COOKIE["member_login"])) { ?> checked
                                        <?php } ?> /> <label for="remember-me">Remember me</label>
                                </div>
                                <div class="remember">
                                    <a href="token.php">Primo login? Clicca qui!</a>
                                </div>
