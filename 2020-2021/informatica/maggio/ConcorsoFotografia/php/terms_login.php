...
<head>
    ...
    <title>Belle Foto srl - TERMS</title>
    <!-- BootStrap -->
...
<div id="content">
    ...
    <div id="mainContent">
        ...
        <div id="contenitoreForm">
            ...
            <div id="divForm">
                <div class="regReg">
                    <h1 class="Titolo">TERMS</h1>
                    <ul class="list-group">
                        <li class="list-group-item">Noi abbiamo il diritto di terminare qualunque account se:</li>
                        <li class="list-group-item">Vengono pubblicate immagine inappropiate</li>
                        <li class="list-group-item">Viene provato di avere un vantaggio verso gli altri tramite fini non leciti</li>
                    </ul>
                </div>
            </div>
