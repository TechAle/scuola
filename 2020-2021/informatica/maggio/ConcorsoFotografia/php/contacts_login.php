        ...
        <div id="contenitoreForm">
            ...
            <div id="divForm">
                <div class="regReg">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">Per chiarimenti, contattare:</li>
                        <li class="list-group-item">Email: alessandro.condello@studenti.fauser.edu</li>
                        <li class="list-group-item">Numero: 800833833</li>
                    </ul>
                </div>
            </div>
