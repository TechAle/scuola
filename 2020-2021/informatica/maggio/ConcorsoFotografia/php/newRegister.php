...
if (!empty($registrationResponse["status"])) {
    if ($registrationResponse["status"] == "error") {
        $messaggio = $registrationResponse["message"];
    } else {
        ...
        $messaggio = $registrationResponse["message"] . "<br>";
        if ($successo) {
            $messaggio .= "Token inviato per mail!";
        } else $messaggio .= "Errore: token non inviato";
    }
}
...
<div id="content">
    ...
    <div id="mainContent">
        ...
        <div id="contenitoreForm">
            ...
            <div id="divForm">
                <div class="loginReg">
                    <h1 class="Titolo">Ben Ritornato!</h1>
                    <h2 class="sottoTitolo">Esegui il login</h2>
                    <div class="cointainerForm">
                        <form control="" class="form-group">
                            <div class="row">
                                <input type="text" name="Email" id="EmailLogin" class="form__input" placeholder="Email">
                            </div>
                            <div class="row">
                                <!-- <span class="fa fa-lock"></span> -->
                                <input type="password" name="password" id="passwordLogin" class="form__input" placeholder="Password">
                            </div>
                            <center>
                                <div class="remember">
                                    <input type="checkbox" name="remember_me" id="remember_meLogin" class="">
                                    <label for="remember_meLogin">Remember Me!</label>
                                </div>
                                <div class="remember">
                                    <a href="token.html">Primo login? Clicca qui!</a>
                                </div>
                ...
                <div class="regReg">
                    ...
                    <form  name="sign-up" action="" method="post" enctype="multipart/form-data"
                           onsubmit="return signupValidation()" class="form-group" style="height: 90%; overflow-y: scroll">
                        <div class="row">
                            <input type="text" name="email" id="email" class="form__input" placeholder="Email">
                        </div>
                        <div class="row">
                            <div class="col sm-12">
                                <input type="text" name="name" id="Nome name" class="form__input" placeholder="Nome">
                            </div>
                            <div class="col sm-12">
                                <input type="text" name="surname" id="Cognome surname" class="form__input" placeholder="Cognome">
                            </div>
                        </div>
                        <div class="row">
                            <!-- <span class="fa fa-lock"></span> -->
                            <input type="password" name="signup-password" id="password" class="form__input" placeholder="Password">
                        </div>
                        <div class="row">
                            <!-- <span class="fa fa-lock"></span> -->
                            <input type="password" name="confirm-password" id="passwordConferma" class="form__input" placeholder="Conferma Password">
                        </div>
                        <div class="row">
                                ...
                                <div class="input-group image-preview">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        <div class="btn btn-default image-preview-input" style="width: 100%">
                                            ...
                                            <input type="file" accept="image/png, image/jpeg, image/gif" name="profile-picture"
                                                   id="profile-picture"/> <!-- rename it -->
                                        </div>
                                    </span>
                                </div>
                            </div>
                        ...
                        <center>
                            ...
                            <input type="submit" name="signup-btn" value="Submit" class="btn">
                        </center>
                    </form>
                </div>
            </div>
