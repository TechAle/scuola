...
<head>
    ...
    <title>Belle Foto srl - Contacts</title>
    <!-- BootStrap -->
...
<div id="content">
    ...
    <div id="mainContent">
        ...
        <div id="contenitoreForm">
            ...
            <div id="divForm">
                <div class="regReg">
                    <h1 class="Titolo">FAQ</h1>
                    <ul class="list-group">
                        <li class="list-group-item">Come posso partecipare al concorso?<br>Basta registrarsi, arriverà un email di conferma e, dopo tale email, si sarà dentro al concorso</li>
                        <li class="list-group-item">Quando provo ad entrare, mi viene detto che il mio account e' stato disabilitato, perche'? Noi possiamo disabilitare qualunque account che non segue i termini di uso (terms). Se il suo account e' stato diabilitato, e' perche' sono stato infrante delle regole</li>
                    </ul>
                </div>
            </div>
