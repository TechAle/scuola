        ...
        <div class="row row-pb-md">
            ...
            <div class="col-md-3 colorlib-widget">
                ...
                <ul class="colorlib-footer-links">
                    ...
                    <li><a href="nuovadomanda.php"><i class="icon-check"></i>Nuova domanda</a></li>
                </ul>
                </p>
            </div>
            ...
            <div class="col-md-3 colorlib-widget">
                ...
                <div class="f-blog">
                    ...
                    <div class="desc">
                        <h2><a href="#">Esempio 1</a></h2>
                        <p class="admin"><span>31 Marzo 2020</span></p>
                    </div>
                </div>
                <div class="f-blog">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>
                        ...
                        <!-- Link back to Colorlib cant be removed. Template is licensed under CC BY 3.0. --><br>
